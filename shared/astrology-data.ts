...
export const I18N: Record<Language, I18nDictionary> = {
  en: {
    ...
    ichingTitle: "Celestial Oracle",
    ichingSub: "ANCIENT WISDOM OF THE BOOK OF CHANGES",
    askQuestion: "WHISPER YOUR QUERY TO THE STALKS",
    castHexagram: "CAST YARROW STALKS",
    formingHexagram: "CHARTING VOID...",
    interpretationTitle: "ORACLE RESPONSE",
    mainHexagram: "PRESENT STATE",
    transformedHexagram: "TRANSFORMATION",
    advice: "SACRED GUIDANCE",
  },
  vi: {
    ...
    ichingTitle: "Kinh Dịch Chiêm Bốc",
    ichingSub: "TRÍ TUỆ CỔ XƯA TỪ CỎ THI",
    askQuestion: "THÌ THẦM CÂU HỎI VÀO HƯ KHÔNG",
    castHexagram: "GIEO QUẺ",
    formingHexagram: "ĐANG LẬP QUẺ...",
    interpretationTitle: "LỜI SẤM TRUYỀN",
    mainHexagram: "QUẺ CHỦ",
    transformedHexagram: "QUẺ BIẾN",
    advice: "LỜI KHUYÊN THIÊNG LIÊNG",
  }
};
